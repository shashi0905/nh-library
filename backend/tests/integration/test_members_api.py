...
@pytest.mark.asyncio
async def test_list_members_empty(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_register_member(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_register_member_duplicate_email(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_get_member(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_get_member_not_found(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_update_member(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_update_member_not_found(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_update_member_duplicate_email(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_list_members_with_pagination(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_list_members_with_cursor(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_register_member_requires_auth(session: AsyncSession) -> None:
...
@pytest.mark.asyncio
async def test_update_member_requires_auth(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_register_member_without_phone(session: AsyncSession, staff_token: str) -> None:
