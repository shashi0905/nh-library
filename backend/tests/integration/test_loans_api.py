...
@pytest.mark.asyncio
async def test_list_loans_empty(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_borrow_book(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_borrow_book_not_found(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_borrow_book_not_available(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_borrow_book_inactive_member(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_return_book(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_return_book_not_found(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_return_book_already_returned(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_get_loan(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_get_loan_not_found(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_list_loans_with_filters(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_list_loans_with_pagination(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_pay_fine(session: AsyncSession, staff_token: str) -> None:
    """Test paying a fine."""
    # Create a book and member
    async with AsyncClient(app=app, base_url="http://test") as client:
        book_response = await client.post(
...
@pytest.mark.asyncio
async def test_pay_fine_not_found(session: AsyncSession, staff_token: str) -> None:
...
@pytest.mark.asyncio
async def test_borrow_book_requires_auth(session: AsyncSession) -> None:
...
@pytest.mark.asyncio
async def test_concurrent_borrow_race_condition(session: AsyncSession, staff_token: str) -> None:
